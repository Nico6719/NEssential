...
const MENU_CONFIG = {
    configPath: "./plugins/NEssential/Config/Cd/Config.json",
    menusPath: "./plugins/NEssential/data/Menus/",
    prefix: "§e§l[菜单] §r",
...
class MenuConfigManager {
    ...
    ensureDirectory() {
        const dataDir = "./plugins/NEssential/data/";
...
class MenuUtils {
    ...
    static getMenuFiles(excludeMain) {
        if (!fs.existsSync(MENU_CONFIG.menusPath)) return [];
...
class MenuDataManager {
    ...
    static initializeAdminMenu() {
        ...
        if (!fs.existsSync(MENU_CONFIG.menusPath + "admin.json")) {
...
class MenuAdminHandler {
    ...
    static showAddSubMenu(player, error, formData) {
        ...
        player.sendForm(form, function(pl, data) {
            ...
            if (fs.existsSync(MENU_CONFIG.menusPath + fileName + ".json")) {
...
class MenuEventListeners {
    ...
    static initializeResources() {
        ...
        if (!fs.existsSync(`${MENU_CONFIG.menusPath}main.json`)) {
